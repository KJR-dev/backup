  ...
  window.onload = function () {
    var chart = new CanvasJS.Chart("chartContainer",
    {
       ...
       data: [
      {
        ...
        dataPoints: [
        	{ x: new Date(2022, 00, 1), y: 450 },
            { x: new Date(2022, 01, 1), y: 414 },
            { x: new Date(2022, 02, 1), y: 520 },
            { x: new Date(2022, 03, 1), y: 460 },
            { x: new Date(2022, 04, 1), y: 450 },
            { x: new Date(2022, 05, 1), y: 500 },
            { x: new Date(2022, 06, 1), y: 480 },
            { x: new Date(2022, 07, 1), y: 490 },
            { x: new Date(2022, 08, 1), y: 410 },
            { x: new Date(2022, 09, 1), y: 500 },
            { x: new Date(2022, 10, 1), y: 480 },
