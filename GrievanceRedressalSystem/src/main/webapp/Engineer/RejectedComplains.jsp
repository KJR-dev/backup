...
<body class="hold-transition sidebar-mini">
	...
	<script type="text/javascript">
		$("document").ready(function() {
			...
			$("#rejectedcomplains1").addClass("menu-open");
			$("#rejectedcomplains2").addClass("active");
			$(".heading").text("Rejected Complains");
		});
		$
				.ajax({
					url : "../Engineer",
					type : "post",
					data : {
						action : "get_All_Rejected_Complains_engineer"
					},
					dataType : "json",
							...
							$("#tbl-viewcomplaints")
									.append(
											'<tbody><tr data-widget="expandable-table" aria-expanded="false"><td><center>'
													...
													+ '</center></td><td class="btn btn-danger my-2"><center>'
					...
					error : function(data, textStatus, errorThrown) {
						swal({
						    ...
						    window.location = "RejectedComplains.jsp";
 						});
					}
