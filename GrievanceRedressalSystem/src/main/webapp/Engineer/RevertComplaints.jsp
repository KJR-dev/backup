...
<body class="hold-transition sidebar-mini">
	...
	<script type="text/javascript">
		$("document").ready(function() {
			...
			$("#revertComplains1").addClass("menu-open");
			$("#revertComplains2").addClass("active");
			$(".heading").text("Revert Complaints");
		});
		$
				.ajax({
					url : "../Engineer",
					type : "post",
					data : {
						action : "get_All_Revert_Complains_engineer"
					},
					dataType : "json",
							...
							$("#tbl-viewcomplaints")
									.append(
											'<tbody><tr data-widget="expandable-table" aria-expanded="false"><td><center>'
													...
													+ '</center></td><td class="btn btn-info my-2"><center>'
					...
					error : function(data, textStatus, errorThrown) {
						swal({
						    ...
						    window.location = "RevertComplaints.jsp";
 						});
					}
